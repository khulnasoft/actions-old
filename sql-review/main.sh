...
# Users can deploy their own SQL Service from https://github.com/khulnasoft/devsecdb/blob/main/Dockerfile.sql-service, thus they can get their own SQL check API and inject it into the repo's environment
API_URL=$BB_SQL_API
if [ -z $API_URL ]
then
    API_URL=https://sql.khulnasoft.com/v1/advise
fi
